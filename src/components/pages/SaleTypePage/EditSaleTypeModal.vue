<template>
  <CustomModal @close.prevent="editToggleModal" :modalActive="editModalActive" :modal-title="modalTitle">
    <div class="modal-content">
      <form @submit.prevent="onSaveButtonClick(curSaleType?.id ?? 0)">
        <input placeholder="Название типа продажи" type="text" v-model="title" @input="validate" class="inputFirstName"/>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    watch(() => props.curSaleType, (br: any) => {
