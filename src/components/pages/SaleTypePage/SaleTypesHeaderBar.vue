<template>
  <div class="header_container">
    ...
    <SaleTypesActionsBlock
        :allSelected="allSelected"
        @deleteSaleTypeClicked="handleDelete"
        @toggleAll="toggleAll"
...
import SaleTypesActionsBlock from "./SaleTypesActionBlock.vue";

export default defineComponent({
  name: 'SaleTypesHeaderBar',
  components: {SaleTypesActionsBlock, CustomButton},
  props: {
    handleSearch: {
      type: Function,
      required: true,
