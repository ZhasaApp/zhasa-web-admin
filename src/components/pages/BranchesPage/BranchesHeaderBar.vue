<template>
  <div class="header_container">
    ...
    <BranchesActionsBlock
        :branches="branches"
        :allSelected="allSelected"
        @deleteBranchClicked="handleDelete"
        @toggleAll="toggleAll"
...
import BranchesActionsBlock from "./BranchesActionBlock.vue";

export default defineComponent({
  name: 'BranchesHeaderBar',
  components: {BranchesActionsBlock, CustomButton},
  props: {
    handleSearch: {
      type: Function,
      required: true,
